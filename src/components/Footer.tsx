    ...
    <footer className="relative py-12 px-4 sm:px-6 lg:px-8 border-t border-white/10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          <motion.button
            onClick={scrollToTop}
            className="p-3 glass rounded-full hover:bg-white/10 transition-all duration-300 group magnetic-btn"
            whileHover={{ y: -5 }}
            whileTap={{ scale: 0.95 }}
          >
            <ArrowUp className="w-6 h-6 group-hover:text-neon-blue transition-colors" />
          </motion.button>
        </div>
        ...
        <div className="text-center space-y-6">
          ...
          >
            ...
            >
              <svg className="w-5 h-5 group-hover:text-neon-blue transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="p-3 glass rounded-lg hover:bg-white/10 transition-all duration-300 group magnetic-btn"
            >
              <svg className="w-5 h-5 group-hover:text-neon-purple transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="p-3 glass rounded-lg hover:bg-white/10 transition-all duration-300 group magnetic-btn"
            >
              <svg className="w-5 h-5 group-hover:text-neon-green transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            <p className="flex items-center justify-center gap-2">
              © {currentYear} Anil Chhetri. Built with 
